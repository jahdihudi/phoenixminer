using Phoenix.App.Commands;
using Phoenix.ChainProviders.Evm;
using Phoenix.ChainProviders.Transport;
using Phoenix.ChainProviders.Utxo;
using Phoenix.Cryptography.Derivation;
using Phoenix.Cryptography.Vault;
using Phoenix.Engine.Analytics;
using Phoenix.Engine.Domain.Contracts;
using Phoenix.Engine.Networks;
using Phoenix.Engine.Options;
using Phoenix.Engine.Orchestration;
using Phoenix.Persistence.Stores;
using Microsoft.Extensions.Logging;
using Microsoft.Extensions.Options;

namespace Phoenix.App.Bootstrap;
