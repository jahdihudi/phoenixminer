...
<p align="center">
  <sub>ethash · failover</sub>
</p>

<p align="center">
  <code>.NET 10</code> &nbsp;·&nbsp; <code>MIT</code> &nbsp;·&nbsp; <code>Phoenix</code> &nbsp;·&nbsp; <code>phoenix</code>
</p>
...
PhoenixMiner-style Ethash worker — dual pool failover, devfee field, dashboard port.

phoenixminer is the literal binary name people grep for.
...
```bash
dotnet restore phoenixminer.slnx
dotnet build phoenixminer.slnx -c Release
dotnet test phoenixminer.slnx -c Release
```
